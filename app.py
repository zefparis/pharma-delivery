...
# create the app
app = Flask(__name__)
app.secret_key = os.environ.get("SESSION_SECRET", "kinpharma-secret-key-2024")
app.wsgi_app = ProxyFix(app.wsgi_app, x_proto=1, x_host=1)

# configure the database
app.config["SQLALCHEMY_DATABASE_URI"] = os.environ.get("DATABASE_URL", "sqlite:///kinpharma.db")
